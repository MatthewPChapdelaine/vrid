...
const _boot = () => {
    ...
    const _loadAsync = () => {
      Promise.all([
        ...
        .then(([
          ...
          const assetEls = assetBalances.map(({asset, quantity, description, divisible}) => {
  ...
  [btcUsername, xcpUsername, assetUsername, createAssetUsername, createBurnUsername, unpackAssetUsername].forEach(username => {
