      ...
      .then(([
        ...
        const _loadEquipment = () => {
          ...
          const equipment = (() => {
            ...
            const equipment = j && j.equipment;

            if (Array.isArray(equipment) && equipment.length === numEquipments && equipment.every(e => e === null || typeof e === 'string')) {
              return equipment;
            } else {
          ...
          const _saveEquipment = () => {
            Cookies.set('data', JSON.stringify({equipment}), {expires: 365});
          };
          ...
          const assetEls = equipment.map((asset, i) => {
