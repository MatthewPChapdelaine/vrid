module.exports = ({random, fetch, Headers, btoa, getPublicKeyFromPrivateKey, crdsUrl}) => {

const getAddress = privateKey => _arrayToBase64(getPublicKeyFromPrivateKey(privateKey));
