...
const _createIssueTx = (src, asset, description, quantity) => fetch(
...
const _createSignedSendBTCTx = (src, dst, quantity, wifKey) => _requestListUnspent(src)
  .then(utxos => {
...
const requestIssuance = (src, asset, description, quantity, wifKey) => _createIssueTx(src, asset, description, quantity)
